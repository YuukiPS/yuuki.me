...
function App() {
  ...
  return (
    <div className="min-h-screen text-zekken-skin bg-transparent font-body selection:bg-rosario-base selection:text-white">
      ...
      <div className="fixed top-0 left-0 h-full pointer-events-none z-50">
         {/* Reverting pointer-events so the menu is clickable */}
        <div className="pointer-events-auto h-full flex flex-col justify-center pl-4 lg:pl-12 w-80">
      ...
      <main className="pl-4 md:pl-80 lg:pl-96 pr-4 md:pr-12 w-full transition-all duration-500 ease-in-out">
